...
'Now... here is the start of the actual assignment.
...
'BONUS SECTION: Defining Variables and setting their starting values.
  ...
  ElseIf ws.Cells(I, 1).Value <> ws.Cells(I + 1, 1).Value Then
    ...
    'now, let's add some conditional formatting for the yearly change value.
        ...
        End If
            ...
            'BONUS SECTION SCRIPT END. Rest of the script to publish data is towards the end of the macro.
...
'BONUS SECTION CONTINUATION START
...
'BONUS SECTION CONTINUATION END
